...
public class HistoryAdapter extends BaseAdapter {
    ...
    public HistoryAdapter(ArrayList<Equipment> list, Context context) {
        this.list = list;
    ...
    public View getView(int position, View converView, ViewGroup viewGroup) {
        if (converView == null) {
            converView = inflate.inflate(R.layout.history_listview, null);
            ...
            viewHolder.label6 = (TextView)converView.findViewById(R.id.list_rent);
        ...
        viewHolder.label6.setText(list.get(position).getList_rent());
    ...
    private class ViewHolder {
        ...
        public TextView label5; //return
        public TextView label6; //rent
    }
}
